  ...
  const products = [
    {
      id: 1,
      name: "Online Store",
      description: "Discover timeless fragrances, cultural heritage, and premium essentials—all in one place. We offer a curated shopping experience that blends heritage with modern elegance. ",
      image: img1,
    },
    {
      id: 2,
      name: "Luxury Perfume",
      description: "A premium long-lasting fragrance with floral and woody notes. Drawing inspiration from Middle Eastern and European perfume-making, it combines luxurious florals and woods for an elegant scent. A fragrance that evolves throughout the day.",
      image: img3,
    },
    {
      id: 3,
      name: "Cashmere Shawl",
      description: "Soft and warm cashmere shawl, perfect for winter and elegant styling. Cashmere has been a symbol of luxury for over a thousand years, originating from the Himalayas. This shawl is woven with the finest cashmere, offering warmth, comfort, and timeless beauty, blending traditional craftsmanship with modern elegance.",
      image: img2,
    },
    {
      id: 4,
      name: "Keffiyeh",
      description: "Traditional Palestinian keffiyeh made from 100% cotton. Worn as a symbol of resilience and cultural pride, it has deep roots in Middle Eastern heritage. This iconic garment is not only a functional accessory but also a powerful representation of Palestinian identity and unity..",
      image: img4,
    }
  ];
         ...
         {products.map((product) => (
           <SwiperSlide key={product.id}>
             <div
               ...
               className=" bg-white rounded-xl shadow-cyan-900 transform transition duration-300 ease-in-out"
             >
               <figure className=" ">
                 <img
                   src={product.image}
        ...
        {[
            {
              ...
              text: "Get Yours Now",
              description: "Upgrade to the latest iPhone with cutting-edge technology and stunning design.",
            ...
            },
            {
              ...
              text: "Stay Warm",
              description: "Stay warm and stylish with our premium collection of winter jackets.",
            ...
            },
            {
              ...
              text: "Shop the Look",
              description: "Protect your eyes in style with our latest collection of sunglasses.",
            ...
            },
            {
              ...
              text: "Wrap Yourself",
              description: "Soft, luxurious shawls perfect for every season and occasion.",
            ...
            },
            {
              ...
              text: "Smell Amazing",
              description: "Indulge in exquisite fragrances with our collection of premium perfumes.",
            ...
            },
            {
              ...
              description: "Symbol of heritage and identity, our Keffiyehs are crafted with premium fabric.",
              offer: "Heritage Woven in Threads – 20% Off",
            },
        ].map((item, index) => (
          <div
            key={index}
            className={`relative w-full h-60 rounded-lg overflow-hidden shadow-lg group ${index<=3 ? "": " lg:col-span-2"}`}
          >
            <img
              src={item.img}
              alt="Sale"
            ...
            <div className="absolute inset-0 bg-gray-900/60 flex flex-col items-center justify-center text-white text-center p-4">
              ...
              <button
                className='btn mt-4 transform transition duration-300 hover:scale-105 hover:btn-success hover:text-white hover:shadow-lg' 
              >
                {item.text}
              </button>
            </div>
